...
?>
                    ...
                    <h10>These knowledge tip(s) will be posted on the college's <a href = "http://www.facebook.com/miet.jammu" target="_blank">facebook page</a> and filtered students will be notified.</h10><br><br> <br>                  
...
<div class="fb-like" data-href="http://www.facebook.com/miet.jammu" data-send="true" data-width="450" data-show-faces="false"></div>
                  ...
                  <form action="facultyknowledgeredirect.php" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
                ...
                <input type="hidden" name="user" value = "<?php echo $user; ?>" >                                        
                        ...
                        <h7>Knowledge Tips of the day:</h7>
...
<input type="submit" name="submit" value="Send Message!" class="button-blue message"></input>
