...
mysql_select_db($db_database)
 or die ("Unable to select database" .mysql_error());
		...
		if ($user!=NULL && ($attendance!=NULL || $results!=NULL || $knowledge!=NULL ) ) {
                
                    
                    
                    
                        if($attendance=='enabled'){
                        $query = "UPDATE user_records SET should_notify_attendance = '1' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                        
                        }
                        
                        if($attendance=='disabled'){
                        $query = "UPDATE user_records SET should_notify_attendance = '0' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                        ...
                        if($results=='enabled'){
                        $query = "UPDATE user_records SET should_notify_result = '1' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                        ...
                        if($results=='disabled'){
                        $query = "UPDATE user_records SET should_notify_result = '0' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                        ...
                        $query = "UPDATE user_records SET should_notify_knowledge = '1' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                        ...
                        $query = "UPDATE user_records SET should_notify_knowledge = '0' WHERE fb_id = '" . "$user'";
    $sql_result = mysql_query($query);
    if(!$sql_result) {throw new Exception("'table access error', QUERY = $query, Error = " . mysql_error());}
                    ...
                    <h18>Your preferences have been set!</h18>
                    ...
                    <h18>Sorry, your preferences could not be set. To try again, please click this <a href="http://apps.facebook.com/infobot/studentsettings.php"  target="_top">link</a>.</h18>
