...
?>
					...
					<h8>Send a common message!</h8><br><br>
 ...
 <h10>This message will be posted on the college's <a href = "http://www.facebook.com/miet.jammu" target="_blank">facebook page</a> and filtered students will be notified.</h10><br><br> <br>                  
...
<div class="fb-like" data-href="http://www.facebook.com/miet.jammu" data-send="true" data-width="450" data-show-faces="false"></div>
                  ...
                  <form action="facultymessagesredirect.php" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
