...
function send_message ($user, $message, $department, $post_url){

$notification = "%40%5B$user%5D%20has%20asked%20$department%20faculty%20a%20question.%20Click%20here%20to%20answer!";





$constructed_query = "SELECT * FROM user_records WHERE department = '" .  "$department" . "'" . " AND faculty = '1' AND should_notify_faculty_query = '1'" ; 
...
$query = "$constructed_query";
    ...
    $url = "https://graph.facebook.com/$fb_id/notifications?access_token=304045013036764|Vx0Gc2QIBnUMfh3dr2nNbhsB0ts&template=$notification&href=message_redirect.php?bounce_back=$redirect_encoded" ;
...
$query = "SELECT department FROM user_records WHERE fb_id=$user AND student = 1"  ;
...
if($post_id = $facebook->api("/miet.jammu/feed","post",$args)){
            ...
            send_message ($user, $message, $department, $post_url);
...
<?php            
			...
			//echo '<br><a href="http://apps.facebook.com/infobot/studenthome.php" target="_top">New post</a>';
		} else {
