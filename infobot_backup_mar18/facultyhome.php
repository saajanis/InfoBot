...
$no_permission_redirect = "http://apps.facebook.com/infobot/facultyindex.php?bounceback_url=http://apps.facebook.com/infobot/facultyhome.php";
?>
<script>
...
<h7>Get live feed from the college!</h7><br><br>
					<div class="hr"></div>
