...
$no_permission_redirect = "http://apps.facebook.com/infobot/index.php?bounceback_url=http://apps.facebook.com/infobot/studentsettings.php";
?>
<script>
...
<?php
$query = "SELECT should_notify_attendance, should_notify_result, should_notify_knowledge FROM user_records WHERE fb_id=$user AND student = '1'"  ;
...
$attendance_notify_checked = !$row['0']?"checked":"unchecked";
$result_notify_checked = !$row['1']?"checked":"unchecked";
$knowledge_notify_checked = !$row['2']?"checked":"unchecked";
...
?>
                    ...
                    <h17>You can selectively choose which notifications InfoBot will send you:</h17>
                    <br><br><br>
                    
                    
                    <form action="studentsettingsredirect.php" method="post" enctype="multipart/form-data" >
                    
                    
                    <h18>Results notifications:</h18>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <input name="results" value="enabled" type="radio" class="general" checked/>&nbsp;Enabled&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="results" value="disabled" type="radio" class="general" <?php echo $result_notify_checked; ?> />&nbsp;Disabled
                    
                    <br><br><br>
                    
                    <h18>Attendance shortage notifications: </h18>
                         
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="attendance" value="enabled" type="radio" class="general"  checked/>&nbsp;Enabled&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="attendance" value="disabled" type="radio" class="general" <?php echo $attendance_notify_checked; ?> />&nbsp;Disabled
                    
                    <br><br><br>
                    
                    <h18>Daily knowledge Tidbits: </h18>
                    ...
                    <input name="knowledge" value="enabled" type="radio" class="general" checked />&nbsp;Enabled&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="knowledge" value="disabled" type="radio" class="general" <?php echo $knowledge_notify_checked; ?>/>&nbsp;Disabled
                    
                    <input type="hidden" name="user" value = "<?php echo $user; ?>" > 
                    
                    
                    <br><br>
                    <input type="submit" name="submit" value="Set Preferences" class="button-blue message"></input>
